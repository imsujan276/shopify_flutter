...
_Shop _$ShopFromJson(Map<String, dynamic> json) => _Shop(
  ...
  primaryDomain: json['primaryDomain'] == null
      ? null
      : PrimaryDomain.fromJson(json['primaryDomain'] as Map<String, dynamic>),
  privacyPolicy: json['privacyPolicy'] == null
      ? null
      : PrivacyPolicy.fromJson(json['privacyPolicy'] as Map<String, dynamic>),
  ...
  termsOfService: json['termsOfService'] == null
      ? null
      : TermsOfService.fromJson(json['termsOfService'] as Map<String, dynamic>),
);
